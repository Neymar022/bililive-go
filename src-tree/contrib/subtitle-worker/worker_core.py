...
def wait_for_output_file(path: str, timeout_seconds: float = 5.0, poll_interval_seconds: float = 0.1) -> bool:
...
def burn_subtitles(
    ...
    with tempfile.TemporaryDirectory(prefix="subtitle-burn-", dir=output_dir) as temp_dir:
        ...
        try:
            ...
            try:
                publish_burned_output(temp_output, output_path)
            except OSError as exc:
